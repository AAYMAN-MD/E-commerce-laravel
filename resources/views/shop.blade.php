    ...
    <div class="container">
        <div class="row">
                                        ...
                                        @foreach ($brands as $brand)
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    id="br{{$brand->id}}" name="brands" @if (in_array($brand->id,explode(',', $q_brands))) checked="checked" @endif value="{{$brand->id}}" type="checkbox" onchange="filterProductsByBrand(this)">
                                                    <label class="form-check-label">{{$brand->name}}</label>
                                                    <p class="font-light">{{( $brand->products ? $brand->products->count() : 0 )}}</p>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
                                        ...
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories"
                                                    type="checkbox" @if (in_array($category->id,explode(',', $q_categories))) checked="checked" @endif value="{{$category->id}}" onchange="filterProductsByCategory(this)">
            ...
            <div class="category-product col-lg-9 col-12 ratio_30">
                            ...
                            <div class="img-wrapper">
                                {{-- <div class="front">
                                    <a href="{{route('shop.product.details',['slug'=>$product->slug])}}">
                                        <img src="assets/images/fashion/product/frent/{{$product->image}}"
                ...
                <div class="m-4">{{$products->WithQueryString()->links('pagination.default')}}</div>
...
<script>
    ...
    function addProductTowishlist(id,name,suantity,price)
    {
        $.ajax({
            type : 'POST',
