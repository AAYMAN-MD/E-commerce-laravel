                                        ...
                                        @if ($product->images)
                                            ...
                                            <div>
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$image}}"
                                                    class="img-fluid w-100 image_zoom_cls-1 blur-up lazyload" alt="{{$product->name}}">
                                            </div>
                                            @endforeach
                                        @endif
                                    </div>
                        ...
                        <div class="product-box">
                            <div class="img-wrapper">
                                {{-- <div class="front">
                                    <a href="{{route('shop.product.details',['slug'=>$rproduct->slug])}}">
                                        <img src="{{asset('assets/images/fashion/product/frent')}}/{{$rproduct->image}}"
                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <h3 class="theme-color">@if ($rproduct->sale_price)
                                        {{$rproduct->sale_price}}
                                        @else
